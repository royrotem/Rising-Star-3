...
Agents:
1. Statistical Analyst   – focuses on numbers, distributions, outliers
2. Domain Expert         – applies engineering domain knowledge
3. Pattern Detective     – looks for hidden patterns and correlations
4. Root Cause Investigator – deep-thinking agent that reasons about causes
5. Safety Auditor        – evaluates safety margins and risks
